...
*Dot and box* language allows to define **[controls](/category/controls)** (i.e. dots, boxes) and **[actions](/category/actions)** grouped into **[steps](/tutorial/actions-and-steps#steps)**
