...
You can add *dot-and-box* tag (just like normal *div* tag) to your page with *code* attribute defining controls and animation steps.  You will see more details on the next page [getting started].
